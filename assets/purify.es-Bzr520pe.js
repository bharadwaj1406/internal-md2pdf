...
let { freeze: S, seal: L, create: ve } = Object,
...
function ht() {
  ...
  const Gt = l.createElement("form"),
    ...
    ye = function () {
      ...
      if (!(G && G === e)) {
        if (
          ...
          (p = $ === "application/xhtml+xml" ? Ie : ue),
          (T = y(e, "ALLOWED_TAGS") ? r({}, e.ALLOWED_TAGS, p) : Ge),
          (d = y(e, "ALLOWED_ATTR") ? r({}, e.ALLOWED_ATTR, p) : We),
          (Le = y(e, "ALLOWED_NAMESPACES")
            ? r({}, e.ALLOWED_NAMESPACES, Ie)
            : Ut),
          (Oe = y(e, "ADD_URI_SAFE_ATTR")
            ? r(I(Ke), e.ADD_URI_SAFE_ATTR, p)
            : Ke),
          ($e = y(e, "ADD_DATA_URI_TAGS")
            ? r(I(qe), e.ADD_DATA_URI_TAGS, p)
            : qe),
          (b = y(e, "FORBID_CONTENTS") ? r({}, e.FORBID_CONTENTS, p) : Re),
          (j = y(e, "FORBID_TAGS") ? r({}, e.FORBID_TAGS, p) : I({})),
          (_e = y(e, "FORBID_ATTR") ? r({}, e.FORBID_ATTR, p) : I({})),
          (H = y(e, "USE_PROFILES") ? e.USE_PROFILES : !1),
          ...
          H &&
            ...
            H.svg === !0 && (r(T, Me), r(d, Pe), r(d, fe)),
            H.svgFilters === !0 && (r(T, we), r(d, Pe), r(d, fe)),
            H.mathMl === !0 && (r(T, xe), r(d, Tt), r(d, fe))),
          e.ADD_TAGS &&
            (typeof e.ADD_TAGS == "function"
              ? (k.tagCheck = e.ADD_TAGS)
              : (T === Ge && (T = I(T)), r(T, e.ADD_TAGS, p))),
          e.ADD_ATTR &&
            (typeof e.ADD_ATTR == "function"
              ? (k.attributeCheck = e.ADD_ATTR)
              : (d === We && (d = I(d)), r(d, e.ADD_ATTR, p))),
          e.ADD_URI_SAFE_ATTR && r(Oe, e.ADD_URI_SAFE_ATTR, p),
          e.FORBID_CONTENTS &&
            (b === Re && (b = I(b)), r(b, e.FORBID_CONTENTS, p)),
          e.ADD_FORBID_CONTENTS &&
            (b === Re && (b = I(b)), r(b, e.ADD_FORBID_CONTENTS, p)),
          Se && (T["#text"] = !0),
          x && r(T, ["html", "head", "body"]),
    ...
    et = function (e) {
      ...
      return (
        ...
        z === C ? Ct.call(t, x ? "html" : "body")[0] : x ? t.documentElement : _
      );
    },
    tt = function (e) {
      return Nt.call(
  ...
  const ot = function (e) {
      let t = null;
      if ((M(A.beforeSanitizeElements, e, null), be(e))) return N(e), !0;
      ...
      if (
        ...
        (ne &&
          ...
          (ne && e.nodeType === Q.comment && h(/<[/\w]/g, e.data)))
      )
        return N(e), !0;
      if (
    ...
    it = function (e, t, n) {
      if (je && (t === "id" || t === "name") && (n in l || n in Gt)) return !1;
      if (!(ge && !_e[t] && h(wt, t))) {
        if (!(Be && h(xt, t))) {
          if (
    ...
    rt = function (e) {
      ...
      for (; f--; ) {
        const _ = t[f],
          { name: m, namespaceURI: D, value: w } = _,
          W = p(m),
          Ne = w;
        ...
        if (
          ...
          (E = n.attrValue),
          Ve && (W === "id" || W === "name") && (P(m, e), (E = kt + E)),
          ne && h(/((--!?|])>)|<\/(style|title|textarea)/i, E))
        ) {
          P(m, e);
          continue;
        }
  ...
  return (
    (o.sanitize = function (i) {
      ...
      if (
        (Ae || ye(e), (o.removed = []), typeof i == "string" && (V = !1), V)
      ) {
        if (i.nodeName) {
